...
const Navbar = () => {
  ...
  console.log(data.allMarkdownRemark.edges[1].node.frontmatter.navItem);
  const navItem = data.allMarkdownRemark.edges[1].node.frontmatter.navItem;
  ...
  const brandLogo = data.allMarkdownRemark.edges[0].node.frontmatter.logoImage;
